...
type CategoryService_FindAllClient interface {
	Recv() (*CategoryListReponse, error)
	grpc.ClientStream
}
...
func (x *categoryServiceFindAllClient) Recv() (*CategoryListReponse, error) {
	m := new(CategoryListReponse)
...
type CategoryService_FindAllServer interface {
	Send(*CategoryListReponse) error
	grpc.ServerStream
}
...
func (x *categoryServiceFindAllServer) Send(m *CategoryListReponse) error {
...
var fileDescriptor0 = []byte{
	...
	0xa5, 0x07, 0xf7, 0x1f, 0xba, 0x23, 0x83, 0x50, 0xd4, 0x1b, 0x2d, 0x65, 0xe4, 0xe2, 0x87, 0x09,
	0x04, 0xa7, 0x16, 0x95, 0x65, 0x26, 0xa7, 0x0a, 0xb9, 0x71, 0x71, 0xb8, 0x65, 0xe6, 0xa5, 0x38,
	0x55, 0x7a, 0xba, 0x08, 0xc9, 0x61, 0x9a, 0x84, 0x1c, 0x2c, 0x52, 0x78, 0x6c, 0x12, 0xf2, 0xe2,
	0x62, 0x07, 0x99, 0xe3, 0x98, 0x93, 0x43, 0xd0, 0x18, 0x59, 0x4c, 0x79, 0x24, 0x5f, 0x1a, 0x30,
	0x26, 0xb1, 0x81, 0xe3, 0xc9, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xf0, 0x40, 0xf0, 0xe4, 0xb9,
	0x01, 0x00, 0x00,
}
